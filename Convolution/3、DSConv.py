...
if __name__ == '__main__':
    ...
    model_x = DSConv_pro(in_channels=512, out_channels=512, morph=0).cuda()
    model_y = DSConv_pro(in_channels=512, out_channels=512, morph=1).cuda()
    ...
    # 论文中的话，是将 out_x 和 out_y concat 后再经过 conv+groupnorm+rule.
