...
class TiedBlockConv2d(nn.Module):
    '''Tied Block Conv2d'''
    def __init__(self, in_planes, planes, kernel_size=3, stride=1, padding=0, bias=True, B=1, args=None, dropout_tbc=0.0, groups=1):
...
if __name__ == '__main__':
    ...
    model = TiedBlockConv2d(512, 512).cuda()
    out = model(x)
    print(out.shape)
